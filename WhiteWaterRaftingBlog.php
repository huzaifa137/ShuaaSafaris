                        ...
                        <div class="related-post-block">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12">
                                    <h3 class="related-title mb30">White-Water Rafting & Bungee Jumping</h3>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="related-post">
                                        ...
                                        <div class="related-img">
                                            <a  class="imghover"><img src="images/waterRafting.jpg" alt="" class="img-responsive" style="width: 361px!important; height: 360px!important;"></a>
                                        </div>
                                        <div class="related-post-content">
                                            <h4 class="related-post-title"><a href="#" class="title" >White-Water Rafting</a></h4>
                                        </div>
                                    </div>
                                    <!-- /.related post -->
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="related-post">
                                        <!-- related post -->
                                        <div class="related-img">
                                            <a  class="imghover"><img src="images/tour_img_2.jpg" alt="" class="img-responsive" style="width: 361px; height: 360px;"></a>
                                        </div>
                                        <div class="related-post-content">
                                            <h4 class="related-post-title"><a href="#" class="title" style="text-align: center;">Water Rafting & Bungee Jumping</a></h4>
                                        </div>
                                    </div>
                                    <!-- /.related post -->
                                </div>
