                        ...
                        <div class="related-post-block">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-12">
                                    <h3 class="related-title mb30">Cultural & religious tourism</h3>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="related-post">
                                        ...
                                        <div class="related-img">
                                            <a  class="imghover"><img src="images/KasubiTombs.jpg" alt="" class="img-responsive" style="width: 361px!important; height: 360px!important;"></a>
                                        </div>
                                        <div class="related-post-content">
                                            <h4 class="related-post-title"><a href="#" class="title" >Cultural & religious tourism</a></h4>
                                        </div>
                                    </div>
                                    <!-- /.related post -->
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="related-post">
                                        ...
                                        <div class="related-post-content">
                                            <h4 class="related-post-title"><a href="#" class="title" style="text-align: center;">Cultural & religious tourism</a></h4>
                                        </div>
                                    </div>
                                    <!-- /.related post -->
                                </div>
                        ...
                        <div class=" widget widget-recent-post">
                            ...
                            <ul class="list-none">
                                <li>
                                    <div class="recent-post">
                                        <div class="recent-pic">
                                            <a href="#" class="imghover"><img src="images/MountainGorilla.jpg" alt="" class="img-fluid" style="width: 68px; height: 68px;"></a>
                                        </div>
                                        <div class="recent-content">
                                            <h5 class="recent-title "><a href="#" class="title">Mountain Gorillas Trekking</a></h5>
                                            <div class="meta">
                                ...
                                <li>
                                    <div class="recent-post">
                                        <div class="recent-pic">
                                            <a href="#" class="imghover"> <img src="images/NatureWalking.jpg" alt="" class="img-responsive" style="width: 68px; height: 68px;"></a>
                                        </div>
                                        <div class="recent-content">
